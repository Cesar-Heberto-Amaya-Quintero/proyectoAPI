            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Agregar videojuego</h1>
                    </div>
            ...
            <div class ="m-4">
                <form method="POST" href="{{route('videojuegos.store')}}" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="genero">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Fecha de salida</label>
                        <input type="date" class="form-control" id="exampleInputEmail1" name="fecha_salida">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="personajes">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Consolas</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="consolas">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Jugadores</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="jugadores">
                    </div>
